...
public class Broadcast implements Parcelable {
    ...
    public Date getStartDate() {
        if (startDate == null) {
            startDate = DateUtils.parseAtomDate(start);
        }
        return startDate;
    }
    ...
    public Date getEndDate() {
        if (endDate == null) {
            endDate = DateUtils.parseAtomDate(start);
        }
        return endDate;
    }
    ...
    /**
     * @param isBlanked The is_blanked
     */
